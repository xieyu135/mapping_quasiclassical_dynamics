...
exe_spec="$HOME/xieyu/program/spectral_density/Debye/main_spec_dens.exe"
exe_gener_lambda0="python $main_dir/gener_lambda0_coupling.py"
exe_gener_lambda1="python $main_dir/gener_lambda1_coupling.py"
exe_gener_input_files="python $HOME/xieyu/program/mapping/scripts/gener_input_files_2model.py"
