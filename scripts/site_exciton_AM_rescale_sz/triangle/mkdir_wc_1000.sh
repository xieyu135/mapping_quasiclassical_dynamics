...
calc_freq_cut="python $program/mapping/scripts/calc_freq_cut.py"
exe_gener_lambda0="python $main_dir/gener_lambda0_coupling.py"
exe_gener_lambda1="python $main_dir/gener_lambda1_coupling.py"
exe_gener_input_files="python $program/mapping/scripts/gener_input_files_aver_PES_freeze_high_freq.py"
...
"  > $f_spec_input
    work_dir="$main_dir/wc_$wc/kdw_$kdw"
    cp env.sh vmat.data run.sh $f_gener_input_files_input $work_dir
