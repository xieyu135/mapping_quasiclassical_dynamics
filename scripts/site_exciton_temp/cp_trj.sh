...
sam_elec=$HOME/forProgram/mapping/src/sampling/SQC/action_angle_uni/main_action_angle_uni.exe
trj0=1
...
python $HOME/forProgram/mapping/src/sampling/sampling2_pjw/extra_ini_trj.py < extra_ini_trj_input
for((i=$trj0;i<=$n_trj;i++))
do
