...
sam_nuc=$HOME/program/mapping/src/sampling/sampling2_pjw/main_initial_sampling.exe
#sam_elec=/home/xieyu/program/mapping/src/sampling/SQC/main_action_angle.exe
sam_elec=$HOME/program/mapping/src/sampling/SQC/action_angle_uni/main_action_angle_uni_angular_triangle.exe
trj0=1
...
python $HOME/program/mapping/src/sampling/sampling2_pjw/extra_ini_trj.py < extra_ini_trj_input
for((i=$trj0;i<=$n_trj;i++))
do
