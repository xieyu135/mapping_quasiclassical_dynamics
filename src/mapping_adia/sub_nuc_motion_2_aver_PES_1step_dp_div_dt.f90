subroutine sub_nuc_motion_2_aver_PES_1step_dp_div_dt(dp_div_dt, &
                           grad, &
                           x_elec, p_elec, &
                           ene, &
                           dij)
...
call sub_calc_dV_eff_div_dx_nuc(dV_eff_div_dx_nuc, &
                           x_elec, p_elec, &
                           grad)

call sub_calc_dp_nuc_kin__dij_term(dp_nuc_kin__dij_term, &
                           x_elec, p_elec, &
                           ene, &
                           dij)
