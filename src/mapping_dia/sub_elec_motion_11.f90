...
subroutine sub_elec_motion_11(x_mode_cur, p_mode_cur, &
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call sub_move(n_state, y_elec, delt_y_elec, ele_dt_half)
  !write(*,*)'x_elec', x_elec
  !write(*,*)'delt_y_elec', delt_y_elec
  !write(*,*) 2.d0**0.5d0
  !write(*,*)'delt_y_elec * sqrt(2)', delt_y_elec*2.d0**0.5d0
  !write(*,*)'y_elec* sqrt(2)', y_elec*2.d0**0.5d0
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !write(*,*)'delt_x_elec * sqrt(2)', delt_x_elec*2.d0**0.5d0
  !write(*,*)'x_elec* sqrt(2)', x_elec*2.d0**0.5d0
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
