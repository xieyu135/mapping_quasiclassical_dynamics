...
subroutine sub_elec_motion_11_aver_PES(x_mode_cur, p_mode_cur, &
...
! half step of x
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  call sub_elec_get_dH_div_dx_or_dp_aver_PES(n_state, Ham, y_elec, dH_div_dp_x)
...
! half step of p_y
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  call sub_elec_get_dH_div_dx_or_dp_aver_PES(n_state, Ham, p_x_elec, dH_div_dy)

  delt_p_y_elec = dH_div_dy

  call sub_move(n_state, p_y_elec, delt_p_y_elec, ele_dt_half)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! one step of y
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  call sub_elec_get_dH_div_dx_or_dp_aver_PES(n_state, Ham, x_elec, dH_div_dp_y)
...
! one step of p_x
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  call sub_elec_get_dH_div_dx_or_dp_aver_PES(n_state, Ham, p_y_elec, dH_div_dx)

  delt_p_x_elec = -dH_div_dx

  call sub_move(n_state, p_x_elec, delt_p_x_elec, ele_dt) 
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
