...
if(label_debug ==1 ) write(*,*) 'sub_read_ini_trj_2 begins!'
...
if(label_debug ==1 ) write(*,*) 'sub_read_parameter_Ham_4 begins!'
...
if (label_aver_PES == 1) then
  ...
  !   write(*,*) i_step
     if ( mod(i_step,n_save_trj) .eq. 0 ) then
       if(label_debug ==1 ) write(*,*) 'sub_get_dia_Ham_elec_Ham_4 begins!'
       ...
       !write(*,*) Ham
       !write(*,*) exci_e
       if(label_debug ==1 ) write(*,*) 'sub_write_trj_2 begins!'
  ...
  !         if(label_diabatic == 1)then
     if(label_debug ==1 ) write(*,*) 'sub_elec_motion_mapping_2_Ham_4_aver_PES  begins!'
  ...
  !   write(*,*) 'sub_elec_motion done'
     if(label_debug ==1 ) write(*,*) 'sub_get_c_n_elec_2 begins!'
     call sub_get_c_n_elec_2(x_elec, p_elec, c_n)
     
     x_pre = x_cur
     p_pre = p_cur

     if(label_debug ==1 ) write(*,*) 'sub_nuc_motion_Ham_4_aver_PES begins!'
