...
! half step of P
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
if(label_debug > 1) write(*,*) 'sub_nuc_get_dHmn_div_dX begin!'
call sub_nuc_get_dHmn_div_dX(n_mode_HO, n_state, &
                               x_mode(1:n_mode_HO), &
                               p_mode(1:n_mode_HO), &
                               freq, k_tun, lambda1, &
                               dHmn_div_dX(1:n_mode_HO,:,:))
if(label_debug > 1) write(*,*) 'sub_nuc_get_dHmn_div_dX_Ham_tor begins!'
...
if(label_debug > 1) write(*,*) 'sub_nuc_get_dHmn_div_dX done!'
call sub_nuc_get_dH_div_dX_or_dP_aver_PES(c_n, dHmn_div_dX, &
                       dH_div_dX)
if(label_debug > 1) write(*,*) 'sub_nuc_get_dH_div_dX_or_dP_aver_PES done!'
delt_P = -dH_div_dX
!write(*,*) delt_P
...
! one step of X
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
if(label_debug > 1) write(*,*) 'sub_nuc_get_dH_div_dP_aver_PES begin!'
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
delt_X = dH_div_dP
!if(label_debug > 1) write(*,*) delt_X(n_mode)
...
! half step of P
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
if(label_debug > 1) write(*,*) 'sub_nuc_get_dHmn_div_dX begins!'
call sub_nuc_get_dHmn_div_dX(n_mode_HO, n_state, &
                               x_mode(1:n_mode_HO), &
                               p_mode(1:n_mode_HO), &
                               freq, k_tun, lambda1, &
