subroutine sub_neglect_minus(nr, &
                             arr_n, &
                             x_tmp_arr, &
                             p_x_tmp_arr, &
                             y_tmp_arr, &
...
real(kind=8) x_tmp_arr(nr, n_state)
real(kind=8) p_x_tmp_arr(nr, n_state)
real(kind=8) y_tmp_arr(nr, n_state)
real(kind=8) p_y_tmp_arr(nr, n_state)
