...
#        self.config['n_mode'] = int(n_mode)
        ...
        section = 'prepare'
        self.config['n_atom'] = int(parser.getint(section, 'n_atom'))
        self.config['n_mode'] = int(parser.getint(section, 'n_mode'))
        self.config['log_type'] = parser.get(section, 'log_type')
        self.config['log'] = parser.get(section, 'log')
        self.config['newlog'] = parser.get(section, 'newlog')
